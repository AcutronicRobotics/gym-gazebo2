...
def getArgsParserMARA():
    ...
    parser.add_argument('-v', '--velocity', type=float, default=0.5, help='Set servo motor velocity. Keep < 1.57 for real speed. Apply with -r --real_speed or when using MARAReal-v0.')
